...
const Header = ({ admin }) => {
    ...
    const { animationBackground, setAnimationBackground, userRefreshed } =
        ...
        <header id="header">
            <Link to={admin ? "/admin" : "/"}>
                <div className="logo-container">
                    ...
                    <h1>
                        Task Planner{admin && " | "}
                        {admin && <span className={"admin"}>Admin Panel</span>}
                    </h1>
                </div>
            </Link>
                ...
                {user.role.name === "ADMIN" && (
                    ...
                    >
                        {admin ? (
                            ...
                            <>
                                <RiAdminFill className={"icon"} /> Go To Admin
                                Panel
                            </>
                        )}
                    </Link>
